...
namespace GeoAPI.Geometries
{
    ...
    public interface IGeometry : ICloneable, IComparable, IComparable<IGeometry>, IEquatable<IGeometry>
    {
        ...
        ///<summary>
        /// Gets a <see cref="ICoordinate"/> that is guaranteed to be part of the geometry, usually the first.
        ///</summary>
        ICoordinate Coordinate { get; }
        
        ///<summary>
        /// Gets an array of <see cref="ICoordinate"/>s that make up this geometry.
        ///</summary>
