...
namespace GeoAPI.Geometries
{
    ...
    public class Coordinate : 
        ...
        ICoordinate, 
#endif
        IComparable<Coordinate>, IEquatable<Coordinate>
    {
        ///<summary>
        ...
        public override bool Equals(object other)
        {
            ...
            if (!(other is ICoordinate))
                return false;
            return (Equals(((ICoordinate)other).ToCoordinate()));
        }
        ...
        public int CompareTo(object o)
        {
            ...
            var iother = (ICoordinate) o;
            return ((ICoordinate) this).CompareTo(iother);
        }
...
#if ImplementsICoordinate
        #region explicit ICoordinate implementation
        ...
        {
            return Equals(other.ToCoordinate());
        }
