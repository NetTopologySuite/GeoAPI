...
{
    /// <summary>
    /// Implements a <see cref="Set"/> based on a hash table.  
    /// This will give the best lookup, add, and remove
    /// performance for very large data-sets, but iteration 
    ...
    public class HashedSet : DictionarySet
    {
        ...
        /// </param>
        public HashedSet(IEnumerable initialValues) : this()
        {
