...
namespace GeoAPI.DataStructures.Collections
{
    ...
    public sealed class ImmutableSet : Set
    {
        ...
        public override Boolean AddRange(IEnumerable c)
        {
            throw new NotSupportedException(ERROR_MESSAGE);
        }
        ...
        public override Boolean ContainsAll(IEnumerable c)
        {
            return _mBasisSet.ContainsAll(c);
        }
        ...
        public override Boolean RemoveAll(IEnumerable c)
        {
            throw new NotSupportedException(ERROR_MESSAGE);
        }
        ...
        public override Boolean RetainAll(IEnumerable c)
        {
            throw new NotSupportedException(ERROR_MESSAGE);
        }
        ...
        public override ISet Union(ISet a)
        {
            ISet m = this;
        ...
        public override ISet Intersect(ISet a)
        {
            ISet m = this;
        ...
        public override ISet Minus(ISet a)
        {
            ISet m = this;
        ...
        public override ISet ExclusiveOr(ISet a)
        {
            ISet m = this;
