...
{
    /// <summary>
    /// Implements a <see cref="Set{T}"/> that automatically changes from a 
    /// list to a hash table when the size reaches a certain threshold.  
    ...
    public class HybridSet<T> : DictionarySet<T>
    {
        ...
        /// depending on which will be more efficient based on the data-set size.
        /// </summary>
        public HybridSet()
        {
        ...
        /// Creates a new set instance based on either a list or a hash table, 
        /// depending on which will be more efficient based on the data-set size,
        /// and initializes it based on a collection of elements.
        /// </summary>
        /// <param name="initialValues">
        /// A collection of elements that defines the initial set contents.
        /// </param>
        public HybridSet(IEnumerable<T> initialValues)
            : this()
        {
