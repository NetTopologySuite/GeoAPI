...
namespace GeoAPI.DataStructures.Collections.Generic
{
    ...
    public interface ISet<T> : ICollection<T>, ICloneable
    {
        ...
        Boolean ContainsAll(IEnumerable<T> c);
        ...
        /// <returns><see langword="true"/> if the object was added, <see langword="false"/> if it was already present.</returns>
        new Boolean Add(T o);
        ...
        Boolean AddRange(IEnumerable<T> c);
        ...
        Boolean RemoveAll(IEnumerable<T> c);
        ...
        Boolean RetainAll(IEnumerable<T> c);
