...
namespace GeoAPI.CoordinateSystems
{
	...
	/// datum.
	/// </summary>
	public interface ICompoundCoordinateSystem<TCoordinate> : ICompoundCoordinateSystem,
                            ...
                            IComputable<Double, TCoordinate>
	{
		...
		/// </summary>
		new ICoordinateSystem<TCoordinate> HeadCoordinateSystem { get; }

		/// <summary>
		/// Gets second sub-coordinate system.
		/// </summary>
		new ICoordinateSystem<TCoordinate> TailCoordinateSystem { get; }
	}
}
