...
namespace GeoAPI.DataStructures.Collections
{
    ...
    /// <remarks>
    /// <para>
    /// This class models the mathematical
    /// <see cref="Set"/> abstraction, and is the base class for all other 
    /// <see cref="Set"/> implementations.  
    /// </para>
    /// <para>
    /// The order of elements in a set is dependant on 
    /// <list type="bullet">
    /// <item><description>the data-structure implementation, and</description></item>
    /// <item><description>the implementation of the various <see cref="Set"/> methods.</description></item>
    /// </list>
    /// A guaranteed order may only be obtained by specific <see cref="Set"/> 
    /// implementations, and should not be assumed.
    /// </para>
    /// <para>
    /// None of the <see cref="Set"/> implementations in this library are guranteed 
    /// to be thread-safe in any way.
    /// </para>
    /// 
    ...
    public abstract class Set : ISet
    {
        ...
        public abstract Boolean AddRange(IEnumerable c);
        ...
        public abstract Boolean ContainsAll(IEnumerable c);
        ...
        public abstract Boolean RemoveAll(IEnumerable c);
        ...
        public abstract Boolean RetainAll(IEnumerable c);
