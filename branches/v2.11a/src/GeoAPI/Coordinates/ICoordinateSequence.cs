...
namespace GeoAPI.Coordinates
{
    ...
    public interface ICoordinateSequence : IList, ICloneable
    {
        ...
        /// </param>
        /// <returns></returns>
        Double this[Int32 index, Ordinates ordinates] { get; set; }
        ...
        /// <summary>
        /// Creates a jagged array of <see cref="Ordinates.X"/>- and <see cref="Ordinates.Y"/>-ordinate values this sequence contains
        /// </summary>
        /// <returns>A jagged array of ordinate values</returns>
        Double[][] ToOrdinateArray2D();

        /// <summary>
        /// Creates a jagged array of all ordinate values this sequence contains
        /// </summary>
        /// <returns>A jagged array of ordinate values</returns>
        Double[][] ToOrdinateArray(params Ordinates[] ordinates);

        /// <summary>
        /// Creates a jagged array of requested ordinate values this sequence contains.
        /// </summary>
        /// <param name="ordinates">The ordinates wanted</param>
        /// <returns>A jagged array of ordinate values.</returns>
        Double[][] ToOrdinateArray(OrdinateFlags ordinates);
